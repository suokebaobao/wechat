<?php /*a:2:{s:81:"D:\system\phpStudy_64\phpstudy_pro\WWW\liunuo-thinkphp6\view\admin\ad\index.phtml";i:1583074303;s:77:"D:\system\phpStudy_64\phpstudy_pro\WWW\liunuo-thinkphp6\view\admin\base.phtml";i:1583074303;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="layui-card">
        ...
        <form action="<?php echo url('admin/ad/index'); ?>" class="layui-form" method="get">
            <div class="layui-form-item">
                <div class="layui-input-inline">
                    <a href="<?php echo url('admin/ad/add'); ?>" class="layui-btn ajax-iframe" data-width="80%" data-height="535px"><i class="fa fa-plus-circle"></i> 添加广告</a>
                </div>
                <div class="layui-input-inline">
                ...
                <div class="layui-btn-group">
                    <a href="<?php echo url('admin/ad/category'); ?>" class="layui-btn ajax-iframe" data-width="700px" data-height="400px"><i class="fa fa-plus-circle"></i> 分类管理</a>
                </div>
            </div>
        </form>
    </div>
    ...
    <script type="text/html" id="tableTBTrack">
        <a href="<?php echo url('admin/ad/edit'); ?>?id={{d.id}}" class="layui-btn ajax-iframe" data-width="80%" data-height="535px">修改</a>
        <a href="<?php echo url('admin/ad/del'); ?>?id={{d.id}}" class="layui-btn layui-btn-danger ajax-delete">删除</a>
    </script>
    <!-- 权限列 -->
    <script type="text/html" id="status">
        <input type="checkbox" name="status" lay-skin="switch" lay-filter="*" lay-text="正常|锁定" data-url="<?php echo url('admin/ad/edit'); ?>?id={{d.id}}" {{d.status==1?'checked':''}}>
    </script>
    <!-- 权限列 -->
    <script type="text/html" id="sort_order">
        <input type="text" name="sort_order" value="{{d.sort_order}}" autocomplete="off" class="layui-input ajax-update" data-url="<?php echo url('admin/ad/edit'); ?>?id={{d.id}}">
    </script>
</div>
...
<script>
    layui.use(['layer', 'form', 'table', 'util', 'dropdown'], function () {
        ...
        var insTb = table.render({
            elem: '#tableList',
            url: "<?php echo url('admin/ad/index_json',['name'=>input('name'),'category'=>input('category')]); ?>",
            page: true,
            cellMinWidth: 100,
            limit:'15',
